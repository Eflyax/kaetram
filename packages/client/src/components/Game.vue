				...
				<div class="parchment-middle">
					<article id="load-character">
						...
						<form onsubmit="return false">
							...
							<label id="remember-me" class="check">
								<div id="remember-me-text">Remember Me</div>
								<input type="checkbox" aria-labelledby="remember-me-text" />
								<span class="checkmark"></span>
							</label>
							<label id="guest" class="check">
								<div id="guest-text">Play as a guest</div>
								<input type="checkbox" aria-labelledby="guest-text" />
								<span class="checkmark"></span>
							</label>

							<button title="Login" aria-label="Login" type="submit" id="login" disabled></button>
							<button
								title="New Account"
					...
					<article id="create-character">
						...
						<form onsubmit="return false">
							...
							<button
								...
								id="cancel-register"
							></button>
							<button title="Play" aria-label="Play" type="submit" id="play"></button>
					...
					<article id="about">
						...
						<p id="a-description">
							Kaetram is a browser-based 2D MMORPG adventure. You play as an adventurer amongst
							others and explore the world of Kaetram. Originally started as a fork of BrowserQuest,
							Kaetram has evolved into its own game. In honour to the original idea, the assets have
							been preserved and expanded upon. We are one of a few open-source community driven
							game projects. We are always looking for assistance in terms of programming, graphic
							artists, and/or music composers. Our source-code can be found on our
							<a target="_blank" href="https://github.com/Kaetram/Kaetram-Open">GitHub Repository</a
							>. If you would like to stay up-to-date with the project, make sure you join our
							<a target="_blank" href="https://discord.gg/MmbGAaw">Discord server</a>.
						</p>
					...
					<article id="git">Structure this later</article>

					<article id="death">
						<p>You have died...</p>
						<button id="respawn" title="Respawn" aria-label="Respawn"></button>
					</article>

					<article id="news">
						<h1>
							<span class="left-ornament"></span>
							<span id="news-title" class="title">Welcome to Kaetram!</span>
							<span class="right-ornament"></span>
						</h1>

						<p id="news-content">
							Kaetram is still in alpha development stage. We are currently looking for developers
							and pixel artists who are interested in helping out! If you encounter any bugs or have
							any suggestions, feel free to submit them on our
							<a target="_blank" href="https://github.com/Kaetram/Kaetram-Open">GitHub</a>
							or
							<a target="_blank" href="https://discord.gg/MmbGAaw">Discord server</a>.
						</p>
					...
					<div class="loader" hidden>
						Connecting<span class="loader-dot">.</span><span class="loader-dot">.</span
