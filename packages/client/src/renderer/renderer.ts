...
export default class Renderer {
	...
	private drawLighting(lighting: RendererLighting): void {
		if (lighting.relative) {
			let lightX = (lighting.light.origX - this.camera.x / this.tileSize) * this.actualTileSize,
				lightY = (lighting.light.origY - this.camera.y / this.tileSize) * this.actualTileSize;
	...
	private clearScreen(context: CanvasRenderingContext2D): void {
		context.clearRect(0, 0, this.entitiesContext.canvas.width, this.entitiesContext.canvas.height);
	}
