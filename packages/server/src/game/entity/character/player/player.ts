...
export default class Player extends Character {
	...
	public loadAchievements(): void {
		this.database.loader?.loadAchievements(this, this.achievements.load.bind(this.achievements));
	}
	...
	public clearAreas(): void {
		if (this.overlayArea && this.overlayArea.type === 'damage') this.overlayArea.removePlayer(this);
	}
